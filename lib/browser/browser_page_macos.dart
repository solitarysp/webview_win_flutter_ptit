...
import 'browser_controller_macos.dart';

class BrowserPageMacos extends StatefulWidget {
  const BrowserPageMacos({super.key});

  @override
  State<BrowserPageMacos> createState() => _BrowserPageMacosState();
}

class _BrowserPageMacosState extends State<BrowserPageMacos> {
  late final BrowserControllerMacos _controller;
  ...
  void initState() {
    super.initState();
    _controller = BrowserControllerMacos()..initialize();
